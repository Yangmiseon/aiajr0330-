...
--6. 1981년 2월 20일 부터 1981년 5월 1일 사이에 입사한 사원의 
--이름, 담당업무, 입사일을 출력하시오.
select ename, job, hiredate from emp
where hiredate BETWEEN '1981-02-20' and '1981-05-01';

--7. 부서번호가 20 및 30에 속한 사원의 >>20과 30모두 속하는거
--이름과 부서번호를 출력, 이름을 기준(내림차순)으로 영문자순으로 출력하시오.
select ename, deptno from emp
