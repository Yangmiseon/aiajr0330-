...
//		while(true) {	//이자리에 와일이 있으면 다시 맨처음 메뉴부터 나옴
		System.out.println(""+Menu1.INSERT_UNIV+". 대학  "
				+ ""+Menu1.INSERT_COMPANY+". 회사  "+Menu1.PRINT_CAFE+". 동호회");
...
//		while(true) {//이위치에 있으면 처음메뉴가 안나옴
		...
		case Menu1.INSERT_UNIV://2.2.3 대학 클래스로 인스턴스 생성
		...
		case Menu1.INSERT_COMPANY://2.2.4 회사 클래스로 인스턴스 생성
		...
		case Menu1.PRINT_CAFE://2.2.5 동호회 클래스로 인스턴스 생성
