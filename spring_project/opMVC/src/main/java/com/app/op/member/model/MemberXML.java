...
@XmlType(name ="", propOrder={"uidx","uid","upw","uname","uphonenumber","uphoto","uregdate"})
public class MemberXML {
	...
	public MemberXML(int uidx, String uid, String upw, String uname, String uphonenumber, String uphoto, Date uregdate) {
		this.uidx = uidx;
		this.uid = uid;
		this.upw = upw;
		this.uname = uname;
	...
	public MemberXML(String uid, String upw, String uname,String uphonenumber) {
